...
namespace TiendaOnline.Controllers
{
    ...
    public class DetallesPedidosController : BaseController
    {
        ...
        {
            var applicationDbContext = _context.DetallePedidos
                .Include(d => d.Pedido)
        ...
        public async Task<IActionResult> Create(
            [Bind("DetallePedidoId,PedidoId,ProductoId,Cantidad,Precio")]
        ...
        )
        {
            ...
            ViewData["PedidoId"] = new SelectList(
                ...
                "PedidoId",
                "Estado",
                detalle_Pedido.PedidoId
            );
            ViewData["ProductoId"] = new SelectList(
                _context.Productos,
                "ProductoId",
                "Codigo",
                detalle_Pedido.ProductoId
            );
            return View(detalle_Pedido);
        }
